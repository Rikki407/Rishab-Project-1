...
public class WeatherTempAPI : MonoBehaviour
{
    public GameObject weatherTextObject;
    string url ="https://api.openweathermap.org/data/2.5/weather?q=Nova%20Scotia&appid=0c9eba2efc7f49e287536a73efd3fd15";
